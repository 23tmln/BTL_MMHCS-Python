        ...
        var WebAssembly = {
          ...
          Instance: function(module2, info) {
            var exports2 = (function instantiate(asmLibraryArg2, wasmMemory2, wasmTable2) {
              function asmFunc(global, env, buffer2) {
                ...
                var HEAPU82 = new global.Uint8Array(buffer2);
                var HEAPU162 = new global.Uint16Array(buffer2);
                var HEAPU322 = new global.Uint32Array(buffer2);
                var HEAPF322 = new global.Float32Array(buffer2);
                var HEAPF642 = new global.Float64Array(buffer2);
                var Math_imul2 = global.Math.imul;
                var Math_fround2 = global.Math.fround;
                var Math_abs2 = global.Math.abs;
                var Math_clz322 = global.Math.clz32;
                var Math_min2 = global.Math.min;
                var Math_max2 = global.Math.max;
                var Math_floor2 = global.Math.floor;
                var Math_ceil2 = global.Math.ceil;
                var Math_sqrt2 = global.Math.sqrt;
              ...
              function base64DecodeToExistingUint8Array(uint8Array, offset, b64) {
                var b1, b2, i2 = 0, j = offset, bLength = b64.length, end = offset + (bLength * 3 >> 2);
                if (b64[bLength - 2] == "=")
                  --end;
                if (b64[bLength - 1] == "=")
                  --end;
                for (; i2 < bLength; i2 += 4, j += 3) {
                  ...
                  if (j + 2 < end)
                    uint8Array[j + 2] = b2 << 6 | base64ReverseLookup[b64.charCodeAt(i2 + 3)];
                }
              }
...
//# sourceMappingURL=chunk-SEPGA5GY.js.map
